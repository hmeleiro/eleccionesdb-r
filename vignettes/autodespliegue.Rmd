...
El repositorio [eleccionesdb-etl](https://hmeleiro.github.io/eleccionesdb-etl/)
...
Consulta la [documentación completa del ETL](https://hmeleiro.github.io/eleccionesdb-etl/)
para requisitos previos (PostgreSQL, paquetes R) y opciones avanzadas.

## Paso 2: Levantar la API

El repositorio [eleccionesdb-api](https://hmeleiro.github.io/eleccionesdb-api/)
...
Consulta la [documentación completa de la API](https://hmeleiro.github.io/eleccionesdb-api/)
